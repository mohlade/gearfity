          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8 text-left">
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-white mb-2">Flexible Part-Time Work</h3>
                    <p className="text-gray-300 text-sm leading-relaxed">
              ...
              <div className="flex flex-col md:flex-row items-center gap-4 text-center md:text-left">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-300 text-sm">
                    Join thousands of service professionals making <span className="text-amber-400 font-semibold">$50-150/hour</span> in the Seattle area. 
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search for painting, plumbing, electrical jobs..."
                  value={searchTerm}
                    ...
                    <div className="p-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {selectedCategoryServices.map(service => (
                          <div key={service.id} className="group bg-gray-50 rounded-xl hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-200 overflow-hidden">
